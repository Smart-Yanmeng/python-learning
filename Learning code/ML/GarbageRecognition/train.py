...
def train(hyp, opt, device, tb_writer=None):
    ...
    for epoch in range(
        ...
        if rank in [-1, 0]:
            ...
            if save:
                with open(
                    results_file, "r", encoding="utf-8"
                ) as f:  # create checkpoint
                    ckpt = {
                        "epoch": epoch,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data", type=str, default="/Garbage/garbage.yaml", help="garbage.yaml path"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--batch-size", type=int, default=2, help="total batch size for all GPUs"
    )
    parser.add_argument(
        "--img-size",
        nargs="+",
    ...
    parser.add_argument(
        "--logdir", type=str, default="Garbage/logs", help="logging directory"
    )
    parser.add_argument(
